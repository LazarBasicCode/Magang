...
<body>
    ...
    <script>
        ...
        const jenisLabel = { q_internasional: 'Jurnal Int.', sinta_nasional: 'Jurnal Nasional', hki: 'HKI', book: 'Buku' };
        ...
        async function handleDelete(id) {
            ...
            try {
                const res = await fetch(`/lppm/dosen/${id}`, { method: 'DELETE', headers: { 'Accept': 'application/json', 'X-CSRF-TOKEN': csrfToken } });
                const result = await res.json();
